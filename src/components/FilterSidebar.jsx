...
export default function FilterSidebar({
  ...
  return (
    <aside className="w-full md:w-64 bg-white p-4 rounded-lg shadow-md flex flex-col min-h-[60vh] relative">
      ...
      {/* Size filter (hidden for accessories if showSize is false) */}
      {showSize && (
